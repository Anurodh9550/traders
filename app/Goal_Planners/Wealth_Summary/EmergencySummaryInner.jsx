...
const router = useRouter();
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <section className="py-20 px-6 mx-6 md:mx-12 bg-gradient-to-r mt-2 from-blue-600 to-indigo-500  text-center text-white rounded-3xl shadow-lg pt-5 pb-5">
                <div className="max-w-6xl mx-auto text-center px-4 ">
                    <h1 className="text-4xl font-semibold text-white-900 mb-2">
                        Wealth <span className="text-yellow-300">Cration </span>
                    </h1>
