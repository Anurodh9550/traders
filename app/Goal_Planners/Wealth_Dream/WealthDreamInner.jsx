...
export default function WealthDreamInner() {
            ...
            <section className="w-full py-12 flex justify-center">
                <div className="max-w-6xl w-full p-8 bg-white rounded-xl shadow-lg">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
                        ...
                        <div
                            onClick={() => router.push(`/Goal_Planners/Wealth_Summary?investmentType=SIP&risk=${risk}&years=${afterYears}&futureValue=${futureValue}&sip=${monthlySIP}`
                            )}
